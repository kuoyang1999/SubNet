...
if __name__ == '__main__':
    ...
    parser.add_argument('--finetuned_model_path', type=str,
                        default='webnlg_models/webnlgfinetune_n_20_act_ca'
    ...
    parser.add_argument('--subnet_mode', type=str, default="mlp", help='')
    parser.add_argument('--sub_ratio', type=float, default=1.0, help='between 0.0 to 1.0')



    args = parser.parse_args()

    assert args.subnet_mode in ['mlp', 'attn', 'both']
    ...
    assert args.tuning_mode in ['prefixtune', 'finetune', 'finetune-top', 'bothtune', 'adaptertune', 'subnettune']
    ...
    if args.dir_name is None:
        Model_FILE = args.mode + args.tuning_mode + '_' + args.optim_prefix[:1] + '_' + str(args.preseqlen) + \
                     ...
                     '_m={}'.format(args.mid_dim) + '_sub={}'.format(args.subnet_mode) + '_ratio={}'.format(args.sub_ratio) + '_a-spar={}'.format(args.sparsity_attn) + '_m-spar={}'.format(args.sparsity_mlp)
    else:
    ...
    COMMANDLINE="python run_language_modeling.py \
        ...
        --sparsity_mlp {} \
        --subnet_mode {} \
        --sub_ratio {} ".format(Model_FILE, OLD_MODEL, OLD_MODEL, args.bsz, args.bsz, args.epoch, TRAIN_FILE, args.mode, TEST_FILE,
                                 args.tuning_mode, logging_dir, args.sparsity_attn, args.sparsity_mlp, args.subnet_mode, args.sub_ratio)
