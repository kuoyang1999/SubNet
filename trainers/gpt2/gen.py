...
if __name__ == '__main__':
    ...
    if mode =='data2text':
        ...
        elif 'subnettune' in sub_model_name:
            tuning_mode = 'subnettune'
            app = ''
    ...
    COMMANDLINE = "python run_generation.py \
        ...
        --subnet_mode {} --sparsity_attn={} --sparsity_mlp={} \
    ".format(MODEL_FILE, Token_FILE, mode, control_mode, tuning_mode, gen_dir, eval_split, subnet_mode, a_spar, m_spar)
