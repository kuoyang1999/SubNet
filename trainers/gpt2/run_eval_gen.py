...
def main():
    ...
    parser.add_argument(
        ...
        default=None,
        required=True,
        help="The model with mask: " + ", ".join(MODEL_CLASSES.keys()),
    )
    ...
    config = AutoConfig.from_pretrained("gpt2-medium", cache_dir=args.cache_dir)
    ...
    if args.task_mode == 'data2text':
        ...
        if QUICK_CHECK:
            ...
            curr_dir = os.path.join('./',
                                    args.gen_dir,
                                    '{}_sub={}_a-spar={}_m-spar={}_{}_{}'.format(temp, args.tuning_mode, args.sparsity_attn, args.sparsity_mlp, split_file, decode_mode))
            print(curr_dir)
            gold_dir = os.path.join('./',
                                    args.gen_dir,
                                    '{}_sub={}_a-spar={}_m-spar={}_{}_{}'.format(temp, args.tuning_mode, args.sparsity_attn, args.sparsity_mlp, split_file, 'gold'))
            print(gold_dir)
            write_e2e_corr(prompt_text_pair, prompt_text_dict, gold_dir)
            src_dir = os.path.join('./',
                                    args.gen_dir,
                                    '{}_sub={}_a-spar={}_m-spar={}_{}_{}'.format(temp, args.tuning_mode, args.sparsity_attn, args.sparsity_mlp, split_file, 'src'))
