...
def main():
    ...
    elif model_args.tuning_mode in ['prefixtune', 'subnettune']:
    ...
    if model_args.tuning_mode == 'adaptertune':
    ...
    elif model_args.tuning_mode == 'subnettune':
        ...
        if model_args.model_name_or_path:
            ...
            config.return_dict = True
            model = GPT2LMHeadModel_SubNet.from_pretrained(
                model_args.model_name_or_path,
                config=config,
                from_tf=bool(".ckpt" in model_args.model_name_or_path),
                cache_dir=model_args.cache_dir,
    ...
    if model_args.tuning_mode == 'prefixtune': # prefixtune
        ...
        if model_args.prefixModel_name_or_path is not None:
            ...
            print("config_prefix:", config_prefix)
        ...
        for name, param in model.named_parameters():
            if "scores" in name:
                ...
                print("Parameters requires grad:", name)
        ...
        params_file = 'subnettune_params.txt'
        with open(params_file, 'w') as file:
            file.write('The total number of trainable subnet parameters is {}'.format(total_params))
        file.close()
    ...
    if 'lowdata' in training_args.output_dir:
        ...
        print(f'python gen.py webnlg yes valid {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        print(f'python gen.py webnlg yes test {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        os.system(f'python gen.py webnlg yes valid {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        os.system(f'python gen.py webnlg yes test {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        ...
        print(f'python gen.py triples yes valid {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        print(f'python gen.py triples yes test {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        os.system(f'python gen.py triples yes valid {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
        os.system(f'python gen.py triples yes test {checkpoint_path} no {model_args.sparsity_attn} {model_args.sparsity_mlp} {model_args.subnet_mode}')
